...
const config = {
  SESSION_ID: process.env.SESSION_ID || "JOEL-XMD~NVpTBZ5S#UIj6-iTb4FobLGNDayRcmGBWRi1pKp044qUNmLr-bLo",
...
// don't use my codes without a permission 🙏
  ...
  OWNER_NUMBER: process.env.OWNER_NUMBER || [255714595078,254706432485],
